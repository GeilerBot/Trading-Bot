        ...
        def on_message(ws, message):
            ...
            if candle_closed:
                ...
                if trade_amt > 0 and trade_amt < money_end:
                    ...
                    embed2.add_embed_field(name='Quantity:', value='quantity', inline=True)
                    embed2.add_embed_field(name='DogeCoin Price:', value='$ price', inline=True)
                    embed2.set_footer(text='Bought DogeCoin at this time')
                    ...
                    if portfolio != 0 and trade_amt != 0:
                        ...
                        embed3.add_embed_field(name='Quantity:', value='quantity', inline=True)
                        embed3.add_embed_field(name='DogeCoin Price:', value='$ price', inline=True)
                        embed3.set_footer(text='Sold DogeCoin at this time')
