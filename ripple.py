        ...
        def on_message(ws, message):
            ...
            if candle_closed:
                ...
                if core_to_trade == True and counter == 0:
                    ...
                    embed = DiscordEmbed(title='Bought Ripple', description='Bought Ripple this much', color=0xffb029)
                    embed.set_thumbnail(url='https://e7.pngegg.com/pngimages/986/696/png-clipart-ripple-cryptocurrency-exchange-investor-blockchain-others-miscellaneous-logo.png')
                    embed.add_embed_field(name='Price:', value='price', inline=True)
                    embed.add_embed_field(name='Quantity:', value='price', inline=True)
                    embed.add_embed_field(name='Ripple Price:', value='price', inline=True)
                    embed.set_footer(text='Bought Ripple at this time')
                    webhook.add_embed(embed)
                    webhook.execute()
                    print(f'Core Investment: We bought ${core_trade_amount} worth of ripple')
                    core_quantity = 0
                    ...
                    embed1 = DiscordEmbed(title='Bought Ripple', description='Bought Ripple this much', color=0xffb029)
                    embed1.set_thumbnail(url='https://e7.pngegg.com/pngimages/986/696/png-clipart-ripple-cryptocurrency-exchange-investor-blockchain-others-miscellaneous-logo.png')
                    embed1.add_embed_field(name='Price:', value='price', inline=True)
                    embed1.add_embed_field(name='Quantity:', value='price', inline=True)
                    embed1.add_embed_field(name='Ripple Price:', value='price', inline=True)
                    embed1.set_footer(text='Bought Ripple at this time')
                    webhook1.add_embed(embed1)
                    webhook1.execute()
                    print(f'Core Investment: We bought ${second_amount} worth of ripple')
                    core_quantity = 0
                    core_quantity += core_trade_amount/last_price
                    core_to_trade = False
                    pass
                ...
                if trade_amt > 0:
                    ...
                    if trade_amt == 0:
                        ...
                        embed2 = DiscordEmbed(title='Bought Ripple', description='Bought Ripple this much', color=0xffb029)
                        embed2.set_thumbnail(url='https://e7.pngegg.com/pngimages/986/696/png-clipart-ripple-cryptocurrency-exchange-investor-blockchain-others-miscellaneous-logo.png')
                        embed2.add_embed_field(name='Price:', value='price', inline=True)
                        embed2.add_embed_field(name='Quantity:', value='price', inline=True)
                        embed2.add_embed_field(name='Ripple Price:', value='price', inline=True)
                        embed2.set_footer(text='Bought Ripple at this time')
                        webhook2.add_embed(embed)
                        webhook2.execute()
                        print(f'We have bought ${trade_amt} worth of ripple')
                    ...
                    if trade_amt == 0:
                        ...
                        embed3 = DiscordEmbed(title='Sell Ripple', description='Sold Ripple this much', color=0xffb029)
                        embed3.set_thumbnail(url='https://e7.pngegg.com/pngimages/986/696/png-clipart-ripple-cryptocurrency-exchange-investor-blockchain-others-miscellaneous-logo.png')
                        embed3.add_embed_field(name='Profit:', value='profit', inline=True)
                        embed3.add_embed_field(name='Quantity:', value='price', inline=True)
                        embed3.add_embed_field(name='Ripple Price:', value='price', inline=True)
                        embed3.set_footer(text='Sold Ripple at this time')
                        webhook3.add_embed(embed)
                        webhook3.execute()
                    print(f'We sold ${-trade_amt} worth of ripple')
