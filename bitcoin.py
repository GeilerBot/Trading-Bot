        ...
        def on_message(ws, message):
            ...
            if candle_closed:
                ...
                if core_to_trade == True and counter == 0:
                    ...
                    embed = DiscordEmbed(title='Bought BitCoin', description='Bought BitCoin this much', color=0xffb029)
                    embed.set_thumbnail(url='https://images-na.ssl-images-amazon.com/images/I/51O6ByIc8OL._AC_SX466_.jpg')
                    embed.add_embed_field(name='Price:', value='price', inline=True)
                    embed.add_embed_field(name='Quantity:', value='price', inline=True)
                    embed.add_embed_field(name='BitCoin Price:', value='price', inline=True)
                    embed.set_footer(text='Bought Bitcoin at this time')
                    ...
                    embed1 = DiscordEmbed(title='Bought BitCoin', description='Bought BitCoin this much', color=0xffb029)
                    embed1.set_thumbnail(url='https://images-na.ssl-images-amazon.com/images/I/51O6ByIc8OL._AC_SX466_.jpg')
                    embed1.add_embed_field(name='Price:', value='price', inline=True)
                    embed1.add_embed_field(name='Quantity:', value='price', inline=True)
                    embed1.add_embed_field(name='BitCoin Price:', value='price', inline=True)
                    embed1.set_footer(text='Bought Bitcoin at this time')
